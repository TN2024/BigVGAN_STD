        ...
        for i, batch in enumerate(train_loader):
            ...
            if rank == rank:
                ...
                if steps % a.stdout_interval == 0:
                    ...
                    result = 'Steps : {:d}, Gen Loss Total : {:4.3f}, Mel-Spec. Error : {:4.3f}, s/b : {:4.3f}'.format(steps, loss_gen_all, mel_error, time.time() - start_b)
...
def main():
    ...
    parser.add_argument('--result_file', default='exp/result.txt')
